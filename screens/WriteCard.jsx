        ...
        try {
            const submit = await fetch(`${api}:3000/submitCard`, {
                ...
                body: JSON.stringify({
                    ...
                    assetsEquipment: assetEquipment ? 'true' : 'false',
                    cardID: cardID,
                    cardTitle: title,
                    condition: condition ? 'true' : 'false',
                    description: description,
                    environmental: environmental ? 'true' : 'false',
                    ...
                    peopleActs: peopleActs ? 'true' : 'false',
                    procedureSystem: procedureSystem ? 'true' : 'false',
