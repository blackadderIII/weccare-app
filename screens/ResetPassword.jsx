    ...
    return (
        <View style={changePass.main}>
            ...
            <ScrollView>
                ...
                <Image source={reset} style={changePass.illustration} />
                ...
                <TouchableOpacity activeOpacity={0.7} style={changePass.buttonContainer}>
                    {isLoading ? <ActivityIndicator color={'white'} size={'small'} style={changePass.button} /> : <Text style={changePass.button}>Reset</Text>}
                </TouchableOpacity>
            </ScrollView>
